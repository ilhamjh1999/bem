...
@section('content')
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <input type="text" name="nama_laporan_pertanggungjawaban" value="{{$program_kerja->nama_laporan_pertanggungjawaban}}"  placeholder="Nama Laporan Kegiatan" class="form-control">
